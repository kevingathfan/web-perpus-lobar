...
<body>
    ...
    <div class="container-form">
        <a href="pilih_perpustakaan.php?library_id=<?= $library_id ?>" class="back-link">
        ...
        <form method="POST" action="proses_iplm.php">
            ...
            <div class="form-section">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <label class="form-label">Jumlah Guru & Tenaga Kependidikan <small class="text-muted">(Perpus Sekolah)</small></label>
                        <input type="number" name="jml_guru" class="form-control" value="0">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Jumlah Siswa <small class="text-muted">(Perpus Sekolah)</small></label>
                        <input type="number" name="jml_siswa" class="form-control" value="0">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Jumlah Karyawan <small class="text-muted">(Perpus Khusus)</small></label>
            ...
            <div class="form-section">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <label class="form-label">NPSN <small class="text-muted">(Khusus Sekolah)</small></label>
            ...
            <div class="form-section">
                ...
                <div class="mb-4">
                    <label class="form-label">Perda Tentang Perpustakaan <small class="text-muted">(Perpus Daerah)</small></label>
